...
const Forgot = () => {
  ...
  const handleSendOtp = () => {
    ...
    emailjs
      .send(
        "service_le8wkeh", // Replace with your EmailJS Service ID
        "template_1k7hh8o", // Replace with your EmailJS Template ID
        {
          to_email: normalizedEmail, // Pass email dynamically
          otp: otpToSend, // Pass the generated OTP
        },
        "FYPTDyV5lPcrd_Vd0" // Replace with your EmailJS Public Key
      )
      .then((response) => {
